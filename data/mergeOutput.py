...
with open(fname2,'r') as f2:
	for line2 in f2:
		...
		assert line1Temp[-2]==line2Temp[2], 'assertion error, %r is not equal to %r'%(line1Temp[-2],line2Temp[2])
		assert line1Temp[-1] == line2Temp[3], 'assertion error, %r is not equal to %r'%(line1Temp[-1],line2Temp[3])
