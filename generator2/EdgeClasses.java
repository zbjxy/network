...
public class EdgeClasses {
	...
	/**
	 * EdgeClasses constructor. Is called by the init method of the
	 * DataGenerator. Further attributes are announced by the method "announce".
	 * 
	 * @param properties
	...
	public EdgeClasses(Properties properties) {
		...
		this.num = 8;
		// maximum speed
		maxSpeed = new int[num]; // the values in the array are calculated in
									// the method announceDataspace
		// maximum capacity
	...
	/**
	 * Announces the time object, the dataspace and the divisor of maximum speed
	 * to the object. This method must be called before the function getMaxSpeed
	 * is called.
	 * 
	 * @param time
	 *            the time object
	 ...
	 *            divisor of maximum speed (10=fast, 50=middle, 250=slow)
	 */
	...
	/**
	 * Computes the decelerated speed of an edge class depending on the usage
